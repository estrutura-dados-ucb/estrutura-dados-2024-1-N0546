...
int main(){
    ...
    NoFilme *filme1, *filme2, *filme3;
		filme1 = (NoFilme*) malloc(sizeof(NoFilme));
		filme2 = (NoFilme*) malloc(sizeof(NoFilme));
		filme3 = (NoFilme*) malloc(sizeof(NoFilme));
